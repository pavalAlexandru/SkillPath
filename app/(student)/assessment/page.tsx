...
export default async function AssessmentOverviewPage() {
    ...
    return (
        <div className="space-y-6">
            <div>
                <h1 className="text-2xl font-bold text-slate-900">Teste & Evaluări</h1>
                <p className="text-sm text-slate-500">
                    Alege o categorie pentru a-ți evalua cunoștințele sau încearcă un test mixt generat automat.
                </p>
            </div>
            ...
            <div className="rounded-xl border border-indigo-100 bg-indigo-50/50 p-6 shadow-sm">
                ...
                <p className="mt-1 text-sm text-indigo-800">
                    Generează un test rapid cu 10 întrebări alese aleatoriu din toate categoriile disponibile.
                </p>
                <Link
