        ...
        <div className="space-y-6">
            ...
            <Card className="bg-slate-50/60">
                <form className="flex flex-wrap items-end gap-3">
                    ...
                    {areFiltre && (
                        <Link href="/students" scroll={false} className="px-2 py-2 text-sm text-slate-500 hover:underline">
                            Resetează
                        </Link>
                    )}
                </form>
                ...
                <table className="w-full text-left text-sm text-slate-600">
                    ...
                    <tr>
                        ...
                        <th className="whitespace-nowrap px-6 py-3">
                            <Link href={buildUrl(1, 'level')} scroll={false} className="hover:text-slate-800">
                                Nivel ↕
                            </Link>
                        </th>
                        <th className="whitespace-nowrap px-6 py-3">
                            <Link href={buildUrl(1, 'assessments')} scroll={false} className="hover:text-slate-800">
                                Evaluări ↕
                            </Link>
                        </th>
                        ...
                        return (
                            <tr key={s.id} className="hover:bg-slate-50">
                                <td className="px-6 py-4 font-medium text-slate-900">
                                    <Link href={`/students/${s.id}`} scroll={false} className="hover:text-indigo-600 hover:underline">
                ...
                {totalPages > 1 && (
                    <div className="flex items-center justify-between border-t border-slate-200 bg-white px-6 py-4">
                        <p className="text-xs text-slate-500">
                            ...
                            </span> din <span className="font-semibold text-slate-800">{totalCount}</span> studenți
                        </p>
